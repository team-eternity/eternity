...
Section "Uninstall"
  ...
  Delete "$INSTDIR\user\fonts\anorexia.se.ttf"
  Delete "$INSTDIR\user\fonts\aqui.se.ttf"
  Delete "$INSTDIR\user\fonts\cure.se.ttf"
  Delete "$INSTDIR\user\fonts\drift.se.ttf"
  Delete "$INSTDIR\user\fonts\edges.se.ttf"
  Delete "$INSTDIR\user\fonts\gelly.se.ttf"
  Delete "$INSTDIR\user\fonts\glisp.se.ttf"
  Delete "$INSTDIR\user\fonts\glisp-bold.se.ttf"
  Delete "$INSTDIR\user\fonts\lime.se.ttf"
  Delete "$INSTDIR\user\fonts\mints-mild.se.ttf"
  Delete "$INSTDIR\user\fonts\mints-strong.se.ttf"
  Delete "$INSTDIR\user\fonts\nu.se.ttf"
  Delete "$INSTDIR\user\fonts\snap.se.ttf"
  Delete "$INSTDIR\user\fonts\Vera.ttf"
  Delete "$INSTDIR\user\fonts\VeraBd.ttf"
  Delete "$INSTDIR\user\fonts\VeraBI.ttf"
  Delete "$INSTDIR\user\fonts\VeraIt.ttf"
  Delete "$INSTDIR\user\fonts\VeraMoBd.ttf"
  Delete "$INSTDIR\user\fonts\VeraMoBI.ttf"
  Delete "$INSTDIR\user\fonts\VeraMoIt.ttf"
  Delete "$INSTDIR\user\fonts\VeraMono.ttf"
  Delete "$INSTDIR\user\fonts\VeraSe.ttf"
  Delete "$INSTDIR\user\fonts\VeraSeBd.ttf"
  Delete "$INSTDIR\user\fonts\LiberationMono-Bold.ttf"
  Delete "$INSTDIR\user\fonts\LiberationMono-BoldItalic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationMono-Italic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationMono-Regular.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-Bold.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-BoldItalic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-Italic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-Regular.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSansNarrow-Bold.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSansNarrow-BoldItalic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSansNarrow-Italic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSansNarrow-Regular.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-Bold.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-BoldItalic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-Italic.ttf"
  Delete "$INSTDIR\user\fonts\LiberationSans-Regular.ttf"
