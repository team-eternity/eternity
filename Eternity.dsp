...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "..\SDL-1.2.14\include" /I "source\win32" /D "NDEBUG" /D "R_LINKEDPORTALS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_SDL_VER" /D "AMX_NODYNALOAD" /D "EE_CDROM_SUPPORT" /D "HAVE_SPCLIB" /D "ZONE_NATIVE" /D "HAVE_STDINT_H" /YX /FD /c
