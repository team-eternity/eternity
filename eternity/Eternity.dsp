...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "C:\Software Dev\SDL-1.2.11\include" /D "_DEBUG" /D "R_LINKEDPORTALS" /D "RANGECHECK" /D "INSTRUMENTED" /D "ZONEIDCHECK" /D "CARDBOARD" /D "POLYOBJECTS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_SDL_VER" /D "R_PORTALS" /D "AMX_NODYNALOAD" /D "EE_CDROM_SUPPORT" /D "TOKE_MEMORIAL" /YX /FD /GZ /c
