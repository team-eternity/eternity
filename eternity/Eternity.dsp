...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "D:\CS Stuff\SDL_1.2.9\include" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_SDL_VER" /D "OVER_UNDER" /D "R_PORTALS" /D "AMX_NODYNALOAD" /D "EE_CDROM_SUPPORT" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "D:\CS Stuff\SDL_1.2.9\include" /I "C:\Software Dev\SDL-1.2.9\include" /D "_DEBUG" /D "RANGECHECK" /D "INSTRUMENTED" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_SDL_VER" /D "OVER_UNDER" /D "R_PORTALS" /D "AMX_NODYNALOAD" /D "EE_CDROM_SUPPORT" /YX /FD /GZ /c
