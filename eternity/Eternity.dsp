...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "D:\CS Stuff\SDL_1.2.9\include" /I "C:\Software Dev\SDL-1.2.9\include" /D "NDEBUG" /D "POLYOBJECTS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_SDL_VER" /D "OVER_UNDER" /D "R_PORTALS" /D "AMX_NODYNALOAD" /D "EE_CDROM_SUPPORT" /D "R_LINKEDPORTALS" /YX /FD /c
