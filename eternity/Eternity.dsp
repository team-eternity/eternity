...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "C:\Software Dev\SDL-1.2.12\include" /D "NDEBUG" /D "R_LINKEDPORTALS" /D "CARDBOARD" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_SDL_VER" /D "AMX_NODYNALOAD" /D "EE_CDROM_SUPPORT" /D "HAVE_SPCLIB" /D "ZONE_NATIVE" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "C:\Software Dev\SDL-1.2.12\include" /D "_DEBUG" /D "RANGECHECK" /D "INSTRUMENTED" /D "ZONEIDCHECK" /D "R_PORTALS" /D "R_LINKEDPORTALS" /D "CARDBOARD" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_SDL_VER" /D "AMX_NODYNALOAD" /D "EE_CDROM_SUPPORT" /D "HAVE_SPCLIB" /D "ZONE_NATIVE" /YX /FD /GZ /c
