...
// P_RandomEx
//
// haleyjd 06/06/08: This P_Random routine returns the full number
// generated by the method Lee Killough devised, rather than casting
// off the top 24 bits. This does not depend upon demo_compatibility
// and is never called from any code segment which is run when
// demo_compatibility is asserted, thus the old RNG is not messed
// with here.
//
unsigned long P_RandomEx(pr_class_t pr_class)
{
   unsigned long boom;
