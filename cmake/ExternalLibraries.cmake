...
if(APPLE)   # TODO: also check the cached variables
   ...
   set(SDL2_LIBRARY "-framework ${CMAKE_CURRENT_BINARY_DIR}/SDL2.Framework" CACHE FILEPATH "")
   set(SDL2_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR} CACHE FILEPATH "")

   set(SDL2_MAIN_LIBRARY "" CACHE FILEPATH "")

   set(SDL2_MIXER_LIBRARY "-framework ${CMAKE_CURRENT_BINARY_DIR}/SDL2_mixer.Framework" CACHE FILEPATH "")
   set(SDL2_MIXER_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR} CACHE FILEPATH "")

   set(SDL2_NET_LIBRARY "-framework ${CMAKE_CURRENT_BINARY_DIR}/SDL2_net.Framework" CACHE FILEPATH "")
   set(SDL2_NET_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR} CACHE FILEPATH "")
endif()
