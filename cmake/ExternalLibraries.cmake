...
if(WIN32 AND DOWNLOAD_LIB)
   if(MSVC)
      file(DOWNLOAD
         "https://revenant1.net/SDL3-devel-3.0.0-VC.zip"
         "${CMAKE_CURRENT_BINARY_DIR}/SDL3-VC.zip"
         EXPECTED_HASH SHA256=D6E40FBFDC4B16F5C3C520B62C8BAB38EC9BB1E2C394AD020A94F4B2ECA601E0)
...
if(WIN32 AND DOWNLOAD_LIB)
   if(MSVC)
      file(DOWNLOAD
         "https://revenant1.net/SDL3_net-devel-3.0.0-VC.zip"
         "${CMAKE_CURRENT_BINARY_DIR}/SDL3_mixer-VC.zip"
         EXPECTED_HASH SHA256=56ECA0F1675548B4091DBC8A404EF79E7335019044BD10EE57A00D4048D50D0A)
      execute_process(COMMAND "${CMAKE_COMMAND}" -E tar xf
         "${CMAKE_CURRENT_BINARY_DIR}/SDL3_mixer-VC.zip"
         WORKING_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}")
...
if(WIN32 AND DOWNLOAD_LIB)
   if(MSVC)
      file(DOWNLOAD
         ...
         EXPECTED_HASH SHA256=1B5F6B6705C2248BA63AF9E3C47F6362623D41468A360850DDF7B98DAADC462E)
      execute_process(COMMAND "${CMAKE_COMMAND}" -E tar xf
         "${CMAKE_CURRENT_BINARY_DIR}/SDL3_net-VC.zip"
         WORKING_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}")
