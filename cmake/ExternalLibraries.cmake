...
if(APPLE)
   ...
   set(SDL2_LIBRARY "-F${CMAKE_CURRENT_BINARY_DIR} -framework SDL2" CACHE FILEPATH "")
   set(SDL2_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/SDL2.Framework/Headers CACHE FILEPATH "")

   set(SDL2_MAIN_LIBRARY "" CACHE FILEPATH "")

   set(SDL2_MIXER_LIBRARY "-F${CMAKE_CURRENT_BINARY_DIR} -framework SDL2_mixer" CACHE FILEPATH "")
   set(SDL2_MIXER_INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/SDL2_mixer.Framework/Headers CACHE FILEPATH "")

   set(SDL2_NET_LIBRARY "-F${CMAKE_CURRENT_BINARY_DIR} -framework SDL2_net" CACHE FILEPATH "")
