...
static void PrintRegInfo(void)
{
   ...
   LogPrintf(_T("ContextFlags: 0x%08x MxCsr: 0x%08x EFlags: 0x%08x\r\n"),
      contextRecord->ContextFlags, contextRecord->MxCsr, contextRecord->EFlags);
   LogPrintf(_T("Rax: 0x%016I64x Rcx: 0x%016I64x Rdx: 0x%016I64x\r\n"),
      contextRecord->Rax, contextRecord->Rcx, contextRecord->Rdx);
   LogPrintf(_T("Rbx: 0x%016I64x Rsp: 0x%016I64x Rbp: 0x%016I64x\r\n"),
      contextRecord->Rbx, contextRecord->Rsp, contextRecord->Rbp);
   LogPrintf(_T("Rsi: 0x%016I64x Rdi: 0x%016I64x R8:  0x%016I64x\r\n"),
      contextRecord->Rsi, contextRecord->Rdi, contextRecord->R8);
   LogPrintf(_T("R9:  0x%016I64x R10: 0x%016I64x R11: 0x%016I64x\r\n"),
      contextRecord->R9, contextRecord->R10, contextRecord->R11);
   LogPrintf(_T("R12: 0x%016I64x R13: 0x%016I64x R14: 0x%016I64x\r\n"),
      contextRecord->R12, contextRecord->R13, contextRecord->R14);
   ...
   LogPrintf(_T("Dr0: 0x%016I64x Dr1: 0x%016I64x Dr2: 0x%016I64x\r\n"),
      contextRecord->Dr0, contextRecord->Dr1, contextRecord->Dr2);
   LogPrintf(_T("Dr3: 0x%016I64x Dr6: 0x%016I64x Dr7: 0x%016I64x\r\n"),
      contextRecord->Dr3, contextRecord->Dr6, contextRecord->Dr7);
   LogPrintf(_T("DebugControl:         0x%016I64x LastBranchToRip:    0x%016I64x\r\n"),
      contextRecord->DebugControl, contextRecord->LastBranchToRip);
...
{
   RtlGetVersion = reinterpret_cast<decltype(RtlGetVersion)>(GetProcAddress(GetModuleHandle(_T("ntdll")), "RtlGetVersion"));
}
