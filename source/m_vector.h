...
struct v3fixed_t
{
    v3fixed_t operator+(const v3fixed_t &other) const { return { x + other.x, y + other.y, z + other.z }; }

    bool operator!() const { return !x && !y && !z; }

    bool operator==(const v3fixed_t &other) const { return x == other.x && y == other.y && z == other.z; }
    ...
    v3fixed_t operator-() const { return v3fixed_t{ -x, -y, -z }; }
...
struct v2fixed_t
{
    ...
    v2fixed_t operator+(const v2fixed_t other) const { return { x + other.x, y + other.y }; }
    ...
    v2fixed_t operator-() const { return { -x, -y }; }

    v2fixed_t abs() const { return { D_abs(x), D_abs(y) }; }

    bool operator!() const { return !x && !y; }

    bool operator!=(const v2fixed_t other) const { return x != other.x || y != other.y; }
    ...
    v2fixed_t fixedMul(const fixed_t scalar) const { return { FixedMul(x, scalar), FixedMul(y, scalar) }; }

    v2fixed_t fixedDiv(const fixed_t scalar) const { return { FixedDiv(x, scalar), FixedDiv(y, scalar) }; }

    v2fixed_t operator/(int scalar) const { return { x / scalar, y / scalar }; }
...
struct v3float_t
{
    ...
    v3float_t operator-(const v3float_t &other) const { return { x - other.x, y - other.y, z - other.z }; }
    ...
    v3float_t operator-() const { return v3float_t{ -x, -y, -z }; }
...
struct v2float_t
{
    ...
    bool operator!=(const v2float_t other) const { return x != other.x || y != other.y; }

    bool operator==(const v2float_t other) const { return x == other.x && y == other.y; }

    v2float_t operator+(const v2float_t other) const { return { x + other.x, y + other.y }; }

    v2float_t operator-(const v2float_t other) const { return { x - other.x, y - other.y }; }

    v2float_t operator-() const { return { -x, -y }; }

    float operator*(const v2float_t other) const { return x * other.x + y * other.y; }

    v2float_t operator*(const float other) const { return { x * other, y * other }; }
    ...
    static v2float_t fromFixed(const v2fixed_t other) { return { M_FixedToFloat(other.x), M_FixedToFloat(other.y) }; }
};
