...
// Authors: James Haley, Stephen McGranahan, Julian Aubourg, Max Waine
//
...
// I_SDLStartSound
//
static int I_SDLStartSound(sfxinfo_t *sound, int cnum, int vol, int sep, int pitch, int pri, int loop, bool reverb)
{
