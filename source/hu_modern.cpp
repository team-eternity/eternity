...
void ModernHUD::DrawStatus(int x, int y)
{
    ...
    {
        tempstr << FC_RED "K" FC_GRAY "  " << hu_player.killcount << "/" << totalmonsters << //
    ...
    {
        tempstr << FC_RED "KILLS" FC_GRAY "  " << hu_player.killcount << "/" << totalmonsters;
    ...
    {
        tempstr << hu_player.killcount << "/" << totalmonsters << "  " FC_RED "KILLS";
