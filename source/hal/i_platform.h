...
enum
{
   EE_COMPILER_MSVC    = 0x00000001,
   EE_COMPILER_CYGWIN  = 0x00000002,
   EE_COMPILER_MINGW   = 0x00000004,
   EE_COMPILER_GCC     = 0x00000008,
   EE_COMPILER_UNKNOWN = 0x00000010,

   // Mask to match any Windows compiler
   EE_COMPILER_WINDOWS = (EE_COMPILER_MSVC | EE_COMPILER_CYGWIN | EE_COMPILER_MINGW),

   // Mask to match any GCC compiler
   EE_COMPILER_GCCANY  = (EE_COMPILER_GCC | EE_COMPILER_CYGWIN | EE_COMPILER_MINGW)
};
