...
static const char *s_HWPNMACE       = HWPNMACE;
static const char *s_HWPNCROSSBOW   = HWPNCROSSBOW;
static const char *s_HWPNBLASTER    = HWPNBLASTER;
static const char *s_HWPNSKULLROD   = HWPNSKULLROD;
static const char *s_HWPNPHOENIXROD = HWPNPHOENIXROD;
static const char *s_HWPNGAUNTLETS  = HWPNGAUNTLETS;
...
dehstr_t deh_strlookup[] = 
{
   ...
   { &s_HWPNMACE,          "HWPNMACE"          },
   { &s_HWPNCROSSBOW,      "HWPNCROSSBOW"      },
   { &s_HWPNBLASTER,       "HWPNBLASTER"       },
   { &s_HWPNSKULLROD,      "HWPNSKULLROD"      },
   { &s_HWPNPHOENIXROD,    "HWPNPHOENIXROD"    },
   { &s_HWPNGAUNTLETS,     "HWPNGAUNTLETS"     },
