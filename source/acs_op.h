...
// ACS0 instructions.
   ...
   /* 203 */ ACSE_OP(BRANCH_CALL,   BRANCH_CALL,        1)
   /* 204 */ ACSE_OP(BRANCH_CALL,   BRANCH_CALLDISCARD, 1)
   /* 205 */ ACSE_OP(BRANCH_RETURN, BRANCH_RETURNVOID,  0)
   /* 206 */ ACSE_OP(BRANCH_RETURN, BRANCH_RETURN,      0)
