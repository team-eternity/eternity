...
static default_t sysdefaults[] = {
    ...
    DEFAULT_BOOL("d_scaniwads", &d_scaniwads, nullptr, true, default_t::wad_no, "1 to scan common locations for IWADs"),
    ...
    // haleyjd 04/21/10
    DEFAULT_FLOAT("s_lowfreq", &s_lowfreq, nullptr, 880.0, 0, UL, default_t::wad_no, "High end of low pass band"),
    DEFAULT_FLOAT("s_highfreq", &s_highfreq, nullptr, 5000.0, 0, UL, default_t::wad_no, "Low end of high pass band"),
    DEFAULT_FLOAT("s_eqpreamp", &s_eqpreamp, nullptr, 0.93896, 0, 100, default_t::wad_no, "Preamplification factor"),
    DEFAULT_FLOAT("s_lowgain", &s_lowgain, nullptr, 1.2, 0, 300, default_t::wad_no, "Low pass gain"),
    DEFAULT_FLOAT("s_midgain", &s_midgain, nullptr, 1.0, 0, 300, default_t::wad_no, "Midrange gain"),
    DEFAULT_FLOAT("s_highgain", &s_highgain, nullptr, 0.8, 0, 300, default_t::wad_no, "High pass gain"),

    DEFAULT_INT("s_enviro_volume", &s_enviro_volume, nullptr, 4, 0, 16, default_t::wad_no,
                "Volume of environmental sound sequences"),

    // haleyjd 12/24/11
    DEFAULT_BOOL("s_hidefmusic", &s_hidefmusic, nullptr, true, default_t::wad_no, "use hi-def music if available"),
    ...
    DEFAULT_INT("i_videodriverid", &i_videodriverid, nullptr, -1, -1, VDR_MAXDRIVERS - 1, default_t::wad_no,
                i_videohelpstr),
    ...
    DEFAULT_INT("mn_favaspectratio", &mn_favaspectratio, nullptr, 0, 0, AR_NUMASPECTRATIOS - 1, default_t::wad_no,
                "Favorite aspect ratio for selection in menus"),

    DEFAULT_INT("mn_favscreentype", &mn_favscreentype, nullptr, 0, 0, MN_NUMSCREENTYPES - 1, default_t::wad_no,
                "Favorite screen type for selection in menus"),
    ...
    DEFAULT_INT("gl_filter_type", &cfg_gl_filter_type, nullptr, CFG_GL_NEAREST, 0, CFG_GL_NUMFILTERS - 1,
                default_t::wad_no, "GL2D texture filtering type (0 = GL_LINEAR, 1 = GL_NEAREST)"),
