...
enum
{
   ...
   EV_STATIC_PORTAL_LINE_PARAM_SIMPLE,      // 491
   EV_STATIC_PORTAL_LINE_PARAM_ANCHORED,    // 492
   EV_STATIC_PORTAL_SECTOR_PARAM_SIMPLE,    // 493
   EV_STATIC_PORTAL_SECTOR_PARAM_ANCHORED,  // 494
   EV_STATIC_PORTAL_SECTOR_PARAM_LINKED,    // 495
   EV_STATIC_PORTAL_LINE_PARAM_COPIED,      // 496
   EV_STATIC_PORTAL_SECTOR_PARAM_COPIED,    // 497
