...
namespace Aeon
{
    ...
    {
    public:
        static fixed_t Sin(const angle_t val) { return fixed_t(finesine[val >> ANGLETOFINESHIFT]); }

        static fixed_t Cos(const angle_t val) { return fixed_t(finecosine[val >> ANGLETOFINESHIFT]); }

        static fixed_t Tan(const angle_t val) { return fixed_t(finetangent[val >> ANGLETOFINESHIFT]); }

        static fixed_t Atan2(const fixed_t y, const fixed_t x) { return fixed_t(P_PointToAngle(0, 0, x, y)); }

        static fixed_t Fabs(const fixed_t val) { return fixed_t(D_abs(val)); }

        static fixed_t Sqrt(const fixed_t val) { return fixed_t(M_DoubleToFixed(sqrt(M_FixedToDouble(val)))); }

        static int Abs(const int val) { return abs(val); }
        ...
        static fixed_t Floor(const fixed_t val) { return fixed_t(val & ~(FRACUNIT - 1)); }
    };
    ...
    public:
        ...
        static int          RangeUInt(const int min, const int max) { return P_RangeRandomEx(pr_aeon, min, max); }
        static int          RangeByte(const uint8_t min, const uint8_t max) { return P_RangeRandom(pr_aeon, min, max); }
    ...
    fixed_t FixedAddFixed(const fixed_t *lval, const fixed_t rval)
    {
        return *lval + rval;
    }
    fixed_t FixedAddInt(const fixed_t *lval, const int rval)
    {
        return *lval + (rval * FRACUNIT);
    }
    fixed_t FixedSubFixed(const fixed_t *lval, const fixed_t rval)
    {
        return *lval - rval;
    }
    fixed_t FixedSubInt(const fixed_t *lval, const int rval)
    {
        return *lval - (rval * FRACUNIT);
    }
    fixed_t FixedMulFixed(const fixed_t *lval, const fixed_t rval)
    {
        return FixedMul(*lval, rval);
    }
    fixed_t FixedMulInt(const fixed_t *lval, const int rval)
    {
        return *lval * rval;
    }
    fixed_t FixedDivFixed(const fixed_t *lval, const fixed_t rval)
    {
        return FixedDiv(*lval, rval);
    }
    fixed_t FixedDivInt(const fixed_t *lval, const int rval)
    {
        return *lval / rval;
    }
    fixed_t FixedLshInt(const fixed_t *lval, const int rval)
    {
        return *lval << rval;
    }
    ...
    double FixedToDouble(const fixed_t *value)
    {
        return M_FixedToDouble(*value);
    }
    ...
    void ScriptObjFixed::Init()
    {
        ...
        for(const aeonbehaviorreg_t &behavior : fixedBehaviors)
            e->RegisterObjectBehaviour("fixed_t", behavior.behavior, behavior.declaration, behavior.funcPointer,
                                       asCALL_GENERIC);

        e->SetDefaultNamespace("fixed_t");
        e->RegisterGlobalFunction("fixed_t FromBits(const int val)", WRAP_FN(ConstructFromBits), asCALL_GENERIC);
        e->SetDefaultNamespace("");

        for(const aeonfuncreg_t &fn : fixedFuncs)
            e->RegisterObjectMethod("fixed_t", fn.declaration, fn.funcPointer, asCALL_GENERIC);

        e->RegisterGlobalFunction("void print(fixed_t)", WRAP_FN_PR(asPrint, (const fixed_t), void), asCALL_GENERIC);
    }
    ...
    angle_t AngleAddAngle(const angle_t *lval, const angle_t rval)
    {
        return *lval + rval;
    }
    angle_t AngleAddFixed(const angle_t *lval, const fixed_t rval)
    {
        return *lval + (FixedToAngle(rval));
    }
    angle_t AngleAddInt(const angle_t *lval, const int rval)
    {
        return *lval + intToAngle(rval);
    }
    angle_t AngleSubAngle(const angle_t *lval, const angle_t rval)
    {
        return *lval - rval;
    }
    angle_t AngleSubFixed(const angle_t *lval, const fixed_t rval)
    {
        return *lval - (FixedToAngle(rval));
    }
    angle_t AngleSubInt(const angle_t *lval, const int rval)
    {
        return *lval - intToAngle(rval);
    }
    ...
    angle_t AngleMulInt(const angle_t *lval, const int rval)
    {
        return *lval * rval;
    }
    angle_t AngleDivAngle(const angle_t *lval, const angle_t rval)
    {
        return *lval / rval;
    }
    ...
    angle_t AngleDivInt(const angle_t *lval, const int rval)
    {
        return *lval / rval;
    }
    ...
    fixed_t AeonAngleToFixed(fixed_t *thisAngle)
    {
        return AngleToFixed(*thisAngle);
    }
    ...
    void ScriptObjAngle::Init()
    {
        ...
        e->RegisterObjectType("angle_t", sizeof(angle_t),
                              asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS_CA | asOBJ_APP_CLASS_ALLINTS);

        for(const aeonbehaviorreg_t &behavior : angleBehaviors)
            e->RegisterObjectBehaviour("angle_t", behavior.behavior, behavior.declaration, behavior.funcPointer,
                                       asCALL_GENERIC);
        ...
        e->RegisterGlobalFunction("void print(angle_t)", WRAP_FN_PR(asPrint, (const angle_t), void), asCALL_GENERIC);
    }
    ...
    void ScriptObjVector2::ConstructFromFixed(const fixed_t x, const fixed_t y, const fixed_t z, v2fixed_t *thisVector)
    {
    ...
    static const aeonbehaviorreg_t vector2Behaviors[] = {
        ...
        { asBEHAVE_CONSTRUCT, "void f(const fixed_t, const fixed_t)",
         WRAP_OBJ_LAST(ScriptObjVector2::ConstructFromFixed)                                                              },
    };
    ...
    void ScriptObjVector2::Init()
    {
        ...
        e->RegisterObjectType("vector2_t", sizeof(v2fixed_t),
                              asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS_CA | asOBJ_APP_CLASS_ALLINTS);

        for(const aeonbehaviorreg_t &behavior : vector2Behaviors)
            e->RegisterObjectBehaviour("vector2_t", behavior.behavior, behavior.declaration, behavior.funcPointer,
                                       asCALL_GENERIC);
        ...
        e->RegisterGlobalFunction("void print(vector2_t)", WRAP_FN_PR(asPrint, (const v2fixed_t), void),
                                  asCALL_GENERIC);
    }
    ...
    void ScriptObjVector3::ConstructFromFixed(const fixed_t x, const fixed_t y, const fixed_t z, v3fixed_t *thisVector)
    {
    ...
    static const aeonbehaviorreg_t vector3Behaviors[] = {
        ...
        { asBEHAVE_CONSTRUCT, "void f(const fixed_t, const fixed_t, const fixed_t)",
         WRAP_OBJ_LAST(ScriptObjVector3::ConstructFromFixed)                                                                             },
    };
    ...
    void ScriptObjVector3::Init()
    {
        ...
        e->RegisterObjectType("vector3_t", sizeof(v3fixed_t),
                              asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS_CA | asOBJ_APP_CLASS_ALLINTS);

        for(const aeonbehaviorreg_t &behavior : vector3Behaviors)
            e->RegisterObjectBehaviour("vector3_t", behavior.behavior, behavior.declaration, behavior.funcPointer,
                                       asCALL_GENERIC);
        ...
        e->RegisterGlobalFunction("void print(vector3_t)", WRAP_FN_PR(asPrint, (const v3fixed_t), void),
                                  asCALL_GENERIC);
    }
} // namespace Aeon
