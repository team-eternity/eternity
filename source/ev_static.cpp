...
static ev_static_t UDMFEternityStaticBindings[] =
{
   ...
   STATICSPEC(303, EV_STATIC_PORTAL_SECTOR_PARAM_SIMPLE)
   STATICSPEC(304, EV_STATIC_PORTAL_SECTOR_PARAM_ANCHORED)
   STATICSPEC(305, EV_STATIC_PORTAL_SECTOR_PARAM_LINKED)
};
