...
static ev_static_t DOOMStaticBindings[] =
{
   ...
   STATICSPEC(492, EV_STATIC_PORTAL_LINE_PARAM_ANCHORED)
   ...
   STATICSPEC(496, EV_STATIC_PORTAL_LINE_PARAM_COPIED)
   STATICSPEC(497, EV_STATIC_PORTAL_SECTOR_PARAM_COPIED)
};
...
static ev_static_t UDMFEternityStaticBindings[] =
{
   ...
   STATICSPEC(303, EV_STATIC_PORTAL_LINE_PARAM_COPIED)
   // Leave gap, because might as well
   STATICSPEC(305, EV_STATIC_PORTAL_SECTOR_PARAM_SIMPLE)
   STATICSPEC(306, EV_STATIC_PORTAL_SECTOR_PARAM_ANCHORED)
   STATICSPEC(307, EV_STATIC_PORTAL_SECTOR_PARAM_LINKED)
   STATICSPEC(308, EV_STATIC_PORTAL_SECTOR_PARAM_COPIED)
};
...
int EV_SpecialForStaticInitName(const char *name)
{
   ...
   static staticname_t namedStatics[] =
   {
      ...
      { EV_STATIC_PORTAL_LINE_PARAM_ANCHORED, "Line_SetAnchoredPortal" },
      { EV_STATIC_PORTAL_LINE_PARAM_COMPAT, "Line_SetPortal"        },
      { EV_STATIC_PORTAL_LINE_PARAM_SIMPLE, "Line_SetSimplePortal"  },
      { EV_STATIC_PORTAL_LINE_PARAM_COPIED  , "Line_SetCopiedPortal" },
      { EV_STATIC_PORTAL_SECTOR_PARAM_ANCHORED, "Sector_SetAnchoredPortal" },
      { EV_STATIC_PORTAL_SECTOR_PARAM_LINKED, "Sector_SetLinkedPortal" },
      { EV_STATIC_PORTAL_SECTOR_PARAM_SIMPLE, "Sector_SetSimplePortal" },
      { EV_STATIC_PORTAL_SECTOR_PARAM_COPIED, "Sector_SetCopiedPortal" },
