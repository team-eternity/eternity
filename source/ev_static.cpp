...
static ev_static_t UDMFEternityStaticBindings[] =
{
   ...
   STATICSPEC(273, EV_STATIC_PORTAL_LINE_PARAM_SIMPLE)
   STATICSPEC(274, EV_STATIC_PORTAL_LINE_PARAM_ANCHORED)
   STATICSPEC(275, EV_STATIC_PORTAL_SECTOR_PARAM_SIMPLE)
   STATICSPEC(276, EV_STATIC_PORTAL_SECTOR_PARAM_ANCHORED)
   STATICSPEC(277, EV_STATIC_PORTAL_SECTOR_PARAM_LINKED)
};
