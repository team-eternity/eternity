...
ev_binding_t DOOMBindings[] =
{
   ...
   LINESPECNAMED(471, ParamSectorSetFloorPanning,      "Sector_SetCeilingPanning")
   LINESPECNAMED(472, ParamSectorSetCeilingPanning,    "Sector_SetFloorPanning")
};
...
ev_binding_t HexenBindings[] =
{
   ...
   LINESPECNAMED(186, ParamSectorSetFloorPanning,      "Sector_SetCeilingPanning")
   LINESPECNAMED(187, ParamSectorSetCeilingPanning,    "Sector_SetFloorPanning")
