...
static textvals_t finaleTypeVals = { finaleTypeStrs, FINALE_NUMFINALES, 0 };

static const char *sectorColormapStrs[] = { "normal", "Boom", "SMMU" };

static textvals_t sectorColormapVals = { sectorColormapStrs, earrlen(sectorColormapStrs), 0 };
