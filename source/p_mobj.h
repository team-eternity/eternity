...
enum mobjflags5_e : unsigned int
{
   ...
   MF5_ALLY               = 0x00000008, // villsa [STRIFE] friendly towards player with matching flag
   ...
   MF5_TRANSLUCENT25      = 0x00000080, // villsa [STRIFE] 25% foreground translucency
   MF5_TRANSLUCENT75      = 0x00000100, // villsa [STRIFE] 75% foreground translucency
