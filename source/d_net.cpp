...
//------------------------------------------------------------------------------
//
// Purpose: DOOM Network game communication and protocol,
//  all OS independent parts.
//
// Authors: James Haley, Charles Gunyon, Ioan Chera, Joan Bruguera Micó
//
    ...
    while(HGetPacket())
    {
        ...
        if(netbuffer->checksum & NCMD_EXIT)
        {
            ...
            if(gamestate == GS_LEVEL)
            {
                ...
                tflash = P_SpawnMobj(players[netconsole].mo->x, players[netconsole].mo->y,
...
void D_InitNetGame()
{
    ...
    usermsg("player %i of %i (%i nodes)", consoleplayer + 1, doomcom->numplayers, doomcom->numnodes);
}
