...
} keyNames[] =
{
   ...
   { KEYD_JOY_PADDLE1_RIGHT,  "joy_paddle1_right"  },
   { KEYD_JOY_PADDLE1_LEFT,   "joy_paddle1_left"   },
   { KEYD_JOY_PADDLE2_RIGHT,  "joy_paddle2_right"  },
   { KEYD_JOY_PADDLE2_LEFT,   "joy_paddle2_left"   },
   { KEYD_JOY_TOUCHPAD,       "joy_touchpad"       },
   { KEYD_JOY_MISC2,          "joy_misc2"          },
   { KEYD_JOY_MISC3,          "joy_misc3"          },
   { KEYD_JOY_MISC4,          "joy_misc4"          },
   { KEYD_JOY_MISC5,          "joy_misc5"          },
   { KEYD_JOY_MISC6,          "joy_misc6"          },
...
} altKeyNames[] =
{
   ...
   { "joy17",  KEYD_JOY_PADDLE1_RIGHT,  },
   { "joy18",  KEYD_JOY_PADDLE1_LEFT,   },
   { "joy19",  KEYD_JOY_PADDLE2_RIGHT,  },
   { "joy20",  KEYD_JOY_PADDLE2_LEFT,   },
   { "joy21",  KEYD_JOY_TOUCHPAD,       },
   { "joy22",  KEYD_JOY_MISC2,          },
   { "joy23",  KEYD_JOY_MISC3,          },
   { "joy24",  KEYD_JOY_MISC4,          },
