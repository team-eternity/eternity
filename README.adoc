...
. Enter `SDL2_0` for the name, and the directory you extracted SDL1.2 to as the value, eg. `C:\Libs\SDL2-2.0.5`.

. Tick 'Set this macro as an environment variable in the build environment' and click OK.

. Repeat the above 2 steps for `SDLMIXER2_0` (C:\Libs\SDL2_mixer-2.0.1) and `SDLNET2_0` (C:\Libs\SDL2_net-2.0.1).
